...
const scrollToElement = () => {
    let el = document.getElementById('OffersSection');
...
<template>
    <div class="absolute left-12 -top-[40px] flex gap-x-1.5 z-10 h-11">
        ...
        <div @click="scrollToElement"
             :class="`transition-all ease-in duration-150 text-sm cursor-pointer font-bold px-10 py-3.5 rounded-tl-xl rounded-tr-xl bg-white text-secondary`">
            Ofertat
        </div>
    </div>
</template>
